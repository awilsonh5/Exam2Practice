...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        for k in range(len(additional_contents)):
            ...
            if len(self.contents) == self.volume:
                for l in range(len(additional_contents)-k-1):
                    s = s + additional_contents[l+k+1]
    ...
    def shrink(self, new_volume):
        ...
        s = ''
        a = ''
        n = len(self.contents)-new_volume
        l = len(self.contents) - (len(self.contents)-new_volume)
    ...
    def reset(self):
        ...
        self.h.insert(self.hp, self.contents)
        self.hp = self.hp + 1
    ...
    def combined_box(self, other_box):
        ...
        #    TIME ESTIMATE:   5 minutes.
        # --------------------------------------------------------------
        c = self.contents + other_box.contents
